...
public class FlipperQnDCtrl {
	...
	private void buildModel(Vector3 position, Vector3 angles) {
		...
		startLabel.transform.eulerAngles = new Vector3(0, 180, 0);
		...
		scoreLabel.transform.eulerAngles = new Vector3(0, 0, 180);
		...
		ballsLabel.transform.eulerAngles = new Vector3(0, 0, 180);
		...
		scoreHolderTop.transform.eulerAngles = new Vector3(-135, 180, 0);
		...
		ballHolderTop.transform.eulerAngles = new Vector3(-135, 180, 0);
		ballHolderTop.transform.localScale = new Vector3(0.06f, 0.3f, 1);

		shellBottomPanel.transform.eulerAngles = new Vector3(90, 0, 0);
