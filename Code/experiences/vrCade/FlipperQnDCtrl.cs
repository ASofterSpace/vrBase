...
public class FlipperQnDCtrl {
	...
	private void buildModel(Vector3 position, Vector3 angles) {
		...
		startLabel.transform.eulerAngles = new Vector3(0, 0, 0);
		startLabel.transform.localScale = new Vector3(0.0792f, 0.13f, 0.025f);
		...
		glassPanel.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		topPlane.transform.eulerAngles = new Vector3(90, 180, 0);
		...
		bottomPlane.transform.eulerAngles = new Vector3(0, 0, 180);
		bottomPlane.transform.localScale = new Vector3(0.0784f, 1, 0.1274f);
		...
		shellBottom.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		shellBottomPanel.transform.eulerAngles = new Vector3(90, 0, 0); // TODO :: evtl. pull this line later?
		...
		scoreLabel.transform.eulerAngles = new Vector3(-90, 0, 0);
		scoreLabel.transform.localScale = new Vector3(0.11f, 1, 0.5f);
		...
		ballsLabel.transform.eulerAngles = new Vector3(-90, 0, 0);
		ballsLabel.transform.localScale = new Vector3(0.09f, 1, 0.5f);
		...
		scoreHolderBottom.transform.eulerAngles = new Vector3(-45, 0, 0);
		scoreHolderBottom.transform.localScale = new Vector3(0.11f, 1, 0.3f);
		...
		scoreHolderTop.transform.eulerAngles = new Vector3(-135, 0, 0);
		scoreHolderTop.transform.localScale = new Vector3(0.11f, 1, 0.3f);
		...
		ballHolderBottom.transform.eulerAngles = new Vector3(-45, 0, 0);
		ballHolderBottom.transform.localScale = new Vector3(0.06f, 1, 0.3f);
		...
		ballHolderTop.transform.eulerAngles = new Vector3(-135, 0, 0);
		ballHolderTop.transform.localScale = new Vector3(0.06f, 1, 0.3f);
		...
		scoresDigitBar.transform.eulerAngles = new Vector3(90, 0, 90);
		...
		ballsDigitBar.transform.eulerAngles = new Vector3(90, 0, 90);
		...
		shellTop.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		shellLeft.transform.eulerAngles = new Vector3(0, 90, 0);
		...
		targetRotatorBar.transform.eulerAngles = new Vector3(90, -25, 0);
		...
		targetRotator.transform.eulerAngles = new Vector3(0, 64, 0);
		...
		curLog.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		flipperLeftBar.transform.eulerAngles = new Vector3(0, -25, 0);
		...
		flipperRightBar.transform.eulerAngles = new Vector3(0, -25, 0);
		...
		curLog.transform.eulerAngles = new Vector3(0, -30, 0);
		...
		curLog.transform.eulerAngles = new Vector3(0, 65, 0);
		...
		curLog.transform.eulerAngles = new Vector3(0, 60, 0);
		...
		curLog.transform.eulerAngles = new Vector3(0, -15, 0);
		...
		curLog.transform.eulerAngles = new Vector3(0, -40, 0);
		...
		pinball.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		legBottomLeft.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		legBottomRight.transform.eulerAngles = new Vector3(0, 0, 0);
		...
		legTopLeft.transform.eulerAngles = new Vector3(0, 0, 0);
	...
	private GameObject createDigitWheel(GameObject parent) {
		...
		digit.transform.eulerAngles = new Vector3(6, 180, 90);
	...
	private GameObject createBarrier(GameObject parent, string name) {
		...
		*/
		...
		if (name.EndsWith("Left")) {
			...
			barrier.transform.eulerAngles = new Vector3(0, -65, 0);
