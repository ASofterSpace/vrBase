...
//			dioramaScienceRoom.transform.parent = mainCtrl.getWorld().transform;
	...
	private void createDiorama(Vector3 position, Vector3 angles) {
		...
		curObj = PrimitiveFactory.createCylinder(40, 0, false, MaterialCtrl.OBJECTS_MATERIALS_METAL_SHINY);
		...
		curObj = PrimitiveFactory.createCylinder(40, 10, false, MaterialCtrl.SPACE_MOON_FLOOR_INNER);
